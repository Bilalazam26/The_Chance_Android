package com.thechance.weatherapp.weather.data.weather.datasource.remote

import com.thechance.weatherapp.BuildConfig
import com.thechance.weatherapp.core.data.utils.safeNetworkRequest
import com.thechance.weatherapp.weather.data.weather.datasource.WeatherDataSource
import com.thechance.weatherapp.weather.data.weather.datasource.remote.dto.*
import com.thechance.weatherapp.weather.domain.location.model.LocationCoordinate
import io.ktor.client.HttpClient
import io.ktor.client.request.get
import com.thechance.weatherapp.weather.data.weather.datasource.remote.mapper.*
...
class RemoteWeatherDataSource(
    ...
    override suspend fun getCurrentWeatherData(locationCoordinate: LocationCoordinate): Result<Map<String,  CurrentWeatherDto>> {
        return safeNetworkRequest<CurrentWeatherResponse> {
            ...
            mapOf(it.timezone to it.toCurrentWeatherDto())
        }
    }
